...
int main(int argc, char** argv) {
  ...
  std::complex<double> *rec_indi_nums = NULL;
  ...
  MPI_Gather(rec_indi_nums, num_elements_per_proc, MPI_DOUBLE_COMPLEX, rec_gather_nums, num_elements_per_proc, MPI_DOUBLE_COMPLEX, 0, MPI_COMM_WORLD);
